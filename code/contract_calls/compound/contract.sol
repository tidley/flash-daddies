...
// https://money-legos.studydefi.com/#/compound?id=examples-solidity
...
contract CompoundManager {
    ...
    function getBorrowBalanceUnderlying(address cToken, address owner)
        public
        view
        returns (uint256)
    {
    ...
    function enterMarkets(
        ...
        uint256[] memory errors =
            IComptroller(CompoundComptrollerAddress).enterMarkets(cTokens);
